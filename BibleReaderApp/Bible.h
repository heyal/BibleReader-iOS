...
@class ReferenceList,Reference,VerseList,Verse;
@class BookOfBible;

@protocol Bible <NSObject>
@required
/**
 ...
 */
-(NSString*)getVerseText:(Reference*)r;
 ...
 */
-(Verse*)getVerse:(BookOfBible*)book chapter:(int)chapter verse:(int)verse;
 ...
 */
-(VerseList*)getVersesContaining:(NSString*)phrase;
 ...
 */
-(ReferenceList*)getReferencesContaining:(NSString*)phrase;
 ...
 */
-(VerseList*)getVerses:(ReferenceList*)references;
 ...
 */
-(int)getLastVerseNumber:(BookOfBible*)book chapter:(int)chapter;

/**
 * @param book The book
 * @return the number of the final chapter of the given book.
 */
-(int)getLastChapterNumber:(BookOfBible*)book;
 ...
 */
-(ReferenceList*)getReferencesInclusive:(Reference*)firstVerse last:(Reference*)lastVerse;
 ...
 */
-(ReferenceList*)getReferencesExclusive:(Reference*)firstVerse last:(Reference*)lastVerse;
 ...
 */
-(ReferenceList*)getReferencesForBook:(BookOfBible*)book;
 ...
 */
-(ReferenceList*)getReferencesForChapter:(BookOfBible*)book chapter:(int)chapter;
 ...
 */
-(ReferenceList*)getReferencesForChapters:(BookOfBible*)book chapter1:(int)chapter1 chapter2:(int)chapter2;
 ...
 */
-(ReferenceList*)getReferencesForPassage:(BookOfBible*)book chapter:(int)chapter verse1:(int)verse1 verse2:(int)verse2;
 ...
 *         passage is invalid in this Bible.
 */
-(ReferenceList*)getReferencesForPassage:(BookOfBible*)book chapter1:(int)chapter1 verse1:(int)verse1 verse2:(int)chapter2 verse2:(int) verse2;
 ...
 */
-(VerseList*)getVersesInclusive:(Reference*)firstVerse last:(Reference*)lastVerse;
 ...
 */
-(VerseList*)getVersesExclusive:(Reference*)firstVerse last:(Reference*)lastVerse;
 ...
 *         invalid in this Bible.
 */
-(VerseList*)getBook:(BookOfBible*)book;
 ...
 */
-(VerseList*)getChapter:(BookOfBible*)book chaoter:(int)chapter;
 ...
 */
-(VerseList*)getChapters:(BookOfBible*)book chapter1:(int)chapter1 chapter2:(int)chapter2;
 ...
 *         empty list if the passage is invalid in this Bible.
 */
-(VerseList*)getPassage:(BookOfBible*)book chapter:(int)chapter verse1:(int)verse1 verse2:(int)verse2;
 ...
 *         empty list if the passage is invalid in this Bible.
 */
-(VerseList*)getPassage:(BookOfBible*)book chapter1:(int)chapter1 verse1:(int)verse1 verse2:(int)chapter2 verse2:(int) verse2;

@end

@interface Bible : NSObject <Bible>
